...
try {
    ...
    if (isset($_FILES['file'])) {
        ...
        // Prepare an SQL statement to update the file_name and file_data in the database
        $stmt = $pdo->prepare("UPDATE files SET file_name = :file_name, file_data = :file_data
        WHERE file_type = :file_type
        AND creative_start_date = :creative_start_date
        AND creative_end_date = :creative_end_date
